...
const MobileDevelopment = () => {
  const features = [
    {
      ...
      description: "We build native iOS apps with Swift, ensuring smooth performance, clean UI, and seamless user experience."
    },
    {
      icon: Settings,
      title: "Android Development", 
      description: "Native Android apps developed in Kotlin/Java with Material Design for intuitive and engaging interfaces."
    },
    {
      icon: Code,
      title: "Cross-Platform",
      description: "Reach more users with apps built in React Native or Flutter, delivering consistent performance on iOS and Android."
    },
    {
      icon: Zap,
      title: "High Performance",
      description: "Optimized apps with fast load times, smooth animations, and reliable functionality for every device."
    }
  ];
  ...
  return (
    <div className="relative min-h-screen overflow-hidden">
        ...
        <div className="container mx-auto px-4 flex flex-col-reverse lg:flex-row items-center gap-12 relative z-10">
          ...
          <div className="lg:w-1/2 space-y-6 animate-fade-in">
            ...
            <p className="text-xl leading-relaxed">
              ...
              From native apps to cross-platform solutions, we ensure your app is fast, beautiful, and functional.
            </p>
            <Button 
              size="lg" 
          ...
          <div className="lg:w-1/2 flex justify-center animate-scale-in">
            <img src={mobileImage} alt="Mobile Development Illustration" className="rounded-2xl shadow-xl" />
          </div>
        </div>
      </section>
      ...
      {/* Mobile App Technology & Process Section */}
