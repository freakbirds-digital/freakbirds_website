  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="bg-gradient-to-r from-[#031273] via-[#1e3a8a] to-[#2563eb] text-white py-20 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center relative z-10">
          <div className="relative flex justify-center animate-fade-in-left">
            ...
            <img src={businessImage} alt="Professional Digital Services" className="w-full max-w-lg relative z-10 rounded-2xl shadow-2xl animate-scale-in" />
          </div>
          <div className="space-y-6 text-center lg:text-left animate-fade-in-right">
            <h1 className="text-4xl lg:text-6xl font-bold leading-tight">Professional Digital Services</h1>
            ...
            <Button size="lg" className="bg-[hsl(var(--accent))] hover:bg-[hsl(var(--accent))]/90 text-black font-semibold shadow-lg" asChild>
      ...
      <section className="py-20 bg-background">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16 animate-fade-in">
            <h2 className="text-3xl lg:text-4xl font-bold mb-6 text-foreground">Our Complete Service Portfolio</h2>
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              From digital development to business support services, we provide end-to-end solutions to help your business succeed in today's competitive market.
            </p>
          </div>
            ...
            {services.map((service, index) => {
              ...
              return (
                <div key={index} className="animate-slide-up" style={{ animationDelay: `${index * 100}ms` }}>
                  <ServiceCard {...service} icon={IconComponent} />
                </div>
              );
            })}
          </div>
      ...
      <section className="py-20 bg-primary/5">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16 animate-fade-in">
            <h2 className="text-3xl lg:text-4xl font-bold mb-6 text-foreground">Our Process</h2>
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              We follow a proven methodology to ensure successful project delivery and client satisfaction at every step.
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {processSteps.map((step, index) => (
              <div key={index} className="text-center animate-scale-in" style={{ animationDelay: `${index * 200}ms` }}>
                <div className="bg-primary text-primary-foreground w-16 h-16 rounded-full flex items-center justify-center text-xl font-bold mx-auto mb-6">{step.step}</div>
